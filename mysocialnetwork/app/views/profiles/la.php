                ...
                <div class="card" style="width: 34.5rem; border-color: silver;">
                    ...
                    <div class="container">
                        <div class="list-group">
                            listes des amis: </br></br>
                            <?php 
                                //var_dump($data['friendlist']); 
                                //var_dump($data['tab']); 
                            ?>
                            
                            <?php foreach($data['tab'] as $arr2) : ?>
                                <?php //foreach ($arr2 as $arr3) : ?>
                                    <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                                        <big><?php echo $arr2->fname.' '.$arr2->lname; ?></big>
                                        <center><small><?php echo $arr2->city.' '.$arr2->birthday; ?></small></center>
                                    </a></br>
                                <?php //endforeach; ?>
                            <?php endforeach; ?>
                        </div>
