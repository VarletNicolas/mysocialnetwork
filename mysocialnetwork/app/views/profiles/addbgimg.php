...
<div class="row">
    <div class="col-lg-6 mx-auto">
        <form action="<?php echo URLROOT; ?>/profiles/addbgimg" method="post" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="col">
                    <input type="submit" class="btn btn-success btn-block" value="Changer l'image de fond">
                </div>
            </div>
        </form>
    </div>
